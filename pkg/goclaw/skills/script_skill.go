...
// (Python, Node.js, Shell scripts) as GoClaw Skill implementations.
//
// A ScriptSkill:
...
// ScriptSkill wraps a ClawdHub skill definition as a GoClaw Skill.
...
// NewScriptSkill creates a GoClaw skill from a ClawdHub definition.
