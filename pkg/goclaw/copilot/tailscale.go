...
// for secure remote access to GoClaw's web services.
//
...
// Architecture:
//
//	Internet ──HTTPS──▶ Tailscale Funnel ──▶ Local GoClaw (e.g. :8080)
//	Tailnet  ──HTTPS──▶ Tailscale Serve  ──▶ Local GoClaw (e.g. :8080)
package copilot
