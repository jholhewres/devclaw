...
const withBadgeTypes = {
  ...
  [badgeTypes.badgeModern]: {
    common: 'size-max flex items-center whitespace-nowrap rounded-md bg-primary text-secondary',
  ...
  return (
    <span className={cx(colors.common, sizes[type][size], colors.styles[color]?.root)}>
      ...
      <button
        ...
        className={cx(
          'outline-brand flex cursor-pointer items-center justify-center p-0.5 transition duration-100 ease-linear focus-visible:outline-2',
