...
describe('ConfigPage', () => {
  ...
  it('should render success message', () => {
    render(
      <ConfigPage title="Title" message={{ type: 'success', text: 'Saved successfully!' }}>
        <div>Content</div>
      </ConfigPage>
    );
  ...
  it('should render error message', () => {
    render(
      <ConfigPage title="Title" message={{ type: 'error', text: 'An error occurred' }}>
        <div>Content</div>
      </ConfigPage>
    );
...
describe('ConfigInput', () => {
  it('should render input with value', () => {
    render(<ConfigInput value="test value" onChange={() => {}} />);
  ...
  it('should call onChange when value changes', async () => {
    ...
    render(<ConfigInput value="" onChange={handleChange} />);
  ...
  it('should render placeholder', () => {
    render(<ConfigInput value="" onChange={() => {}} placeholder="Enter value" />);

    expect(screen.getByPlaceholderText('Enter value')).toBeInTheDocument();
  });

  it('should be disabled when disabled prop is true', () => {
    render(<ConfigInput value="" onChange={() => {}} disabled />);
...
describe('ConfigSelect', () => {
  ...
  it('should render select with options', () => {
    render(<ConfigSelect value="option1" onChange={() => {}} options={options} />);
  ...
  it('should call onChange when selection changes', async () => {
    const handleChange = vi.fn();
    render(<ConfigSelect value="option1" onChange={handleChange} options={options} />);
...
describe('ConfigToggle', () => {
  it('should render toggle with label', () => {
    render(<ConfigToggle enabled={false} onChange={() => {}} label="Enable feature" />);
  ...
  it('should call onChange when clicked', async () => {
    const handleChange = vi.fn();
    render(<ConfigToggle enabled={false} onChange={handleChange} label="Toggle" />);
  ...
  it('should be disabled when disabled prop is true', async () => {
    const handleChange = vi.fn();
    render(<ConfigToggle enabled={false} onChange={handleChange} label="Toggle" disabled />);
...
describe('ConfigTextarea', () => {
  it('should render textarea with value', () => {
    render(<ConfigTextarea value="test content" onChange={() => {}} />);
  ...
  it('should call onChange when value changes', async () => {
    const handleChange = vi.fn();
    render(<ConfigTextarea value="" onChange={handleChange} />);
...
describe('ConfigTagList', () => {
  it('should render tags', () => {
    render(<ConfigTagList tags={['tag1', 'tag2']} onAdd={() => {}} onRemove={() => {}} />);
  ...
  it('should call onRemove when remove button is clicked', async () => {
    ...
    render(<ConfigTagList tags={['tag1']} onAdd={() => {}} onRemove={handleRemove} />);
  ...
  it('should call onAdd when adding a new tag', async () => {
    ...
    render(<ConfigTagList tags={[]} onAdd={handleAdd} onRemove={() => {}} />);
  ...
  it('should show empty message when no tags and not readOnly', () => {
    render(<ConfigTagList tags={[]} onAdd={() => {}} onRemove={() => {}} readOnly={false} />);

    expect(screen.getByText('No items')).toBeInTheDocument();
  });

  it('should not show empty message when readOnly', () => {
    render(<ConfigTagList tags={[]} onAdd={() => {}} onRemove={() => {}} readOnly />);
