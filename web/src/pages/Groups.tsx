...
import { Users, MessageSquare, Bell, BellOff } from 'lucide-react';
      ...
      >
        ...
        <ConfigField label={t('groups.maxParticipants')} hint={t('groups.maxParticipantsHint')}>
          <ConfigInput
            ...
            onChange={(v) =>
              setConfig((prev) => (prev ? { ...prev, max_participants: parseInt(v) || 100 } : prev))
            }
          />
        </ConfigField>
      </ConfigSection>
          ...
          <div className="grid grid-cols-1 gap-4 pt-2 sm:grid-cols-2">
            <ConfigField label={t('groups.quietHoursStart')}>
              <ConfigInput
                ...
                onChange={(v) =>
                  setConfig((prev) => (prev ? { ...prev, quiet_hours_start: v } : prev))
                }
              />
            </ConfigField>
            ...
            <ConfigField label={t('groups.quietHoursEnd')}>
              <ConfigInput
                ...
                onChange={(v) =>
                  setConfig((prev) => (prev ? { ...prev, quiet_hours_end: v } : prev))
                }
              />
            </ConfigField>
          </div>
